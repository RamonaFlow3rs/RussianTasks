...
--
-- Хост: localhost
-- Время создания: Мар 21 2018 г., 00:34
...
(NULL, 'jerihon_rt_database', 'activation', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'jerihon_rt_database', 'activation', 'username', 2, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'utf8', 'utf8_general_ci', 'text', '', '', 'select,insert,update,references', ''),
(NULL, 'jerihon_rt_database', 'activation', 'userkey', 3, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'utf8', 'utf8_general_ci', 'text', '', '', 'select,insert,update,references', ''),
(NULL, 'jerihon_rt_database', 'activation', 'machineid', 4, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'utf8', 'utf8_general_ci', 'text', '', '', 'select,insert,update,references', ''),
(NULL, 'jerihon_rt_database', 'activation', 'date', 5, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', '');
...
('ABORTED_CLIENTS', '0'),
('ABORTED_CONNECTS', '600'),
('BINLOG_CACHE_DISK_USE', '0'),
('BINLOG_CACHE_USE', '0'),
('BYTES_RECEIVED', '108307935'),
('BYTES_SENT', '2093619535'),
('COM_ADMIN_COMMANDS', '3372'),
...
('COM_SHOW_DATABASES', '1094'),
('COM_SHOW_ENGINE_LOGS', '0'),
('COM_SHOW_ENGINE_MUTEX', '0'),
('COM_SHOW_ENGINE_STATUS', '0'),
('COM_SHOW_EVENTS', '0'),
('COM_SHOW_ERRORS', '0'),
('COM_SHOW_FIELDS', '2241'),
...
('COMPRESSION', 'OFF'),
('CONNECTIONS', '32566'),
('CREATED_TMP_DISK_TABLES', '7012'),
('CREATED_TMP_FILES', '19'),
('CREATED_TMP_TABLES', '33466'),
('DELAYED_ERRORS', '0'),
('DELAYED_INSERT_THREADS', '0'),
('DELAYED_WRITES', '48'),
('FLUSH_COMMANDS', '1'),
('HANDLER_COMMIT', '901'),
('HANDLER_DELETE', '13528'),
('HANDLER_DISCOVER', '0'),
('HANDLER_PREPARE', '0'),
('HANDLER_READ_FIRST', '23630'),
('HANDLER_READ_KEY', '1686180'),
('HANDLER_READ_NEXT', '3338011362'),
('HANDLER_READ_PREV', '1602215'),
('HANDLER_READ_RND', '951843'),
('HANDLER_READ_RND_NEXT', '57501662'),
('HANDLER_ROLLBACK', '0'),
('HANDLER_SAVEPOINT', '0'),
('HANDLER_SAVEPOINT_ROLLBACK', '0'),
('HANDLER_UPDATE', '63556'),
('HANDLER_WRITE', '21750641'),
('INNODB_BUFFER_POOL_PAGES_DATA', '511'),
('INNODB_BUFFER_POOL_PAGES_DIRTY', '0'),
('INNODB_BUFFER_POOL_PAGES_FLUSHED', '765'),
('INNODB_BUFFER_POOL_PAGES_FREE', '0'),
('INNODB_BUFFER_POOL_PAGES_MISC', '1'),
('INNODB_BUFFER_POOL_PAGES_TOTAL', '512'),
('INNODB_BUFFER_POOL_READ_AHEAD_RND', '11167'),
('INNODB_BUFFER_POOL_READ_AHEAD_SEQ', '124'),
('INNODB_BUFFER_POOL_READ_REQUESTS', '6301678'),
('INNODB_BUFFER_POOL_READS', '275299'),
('INNODB_BUFFER_POOL_WAIT_FREE', '0'),
('INNODB_BUFFER_POOL_WRITE_REQUESTS', '2528'),
('INNODB_DATA_FSYNCS', '672'),
('INNODB_DATA_PENDING_FSYNCS', '0'),
('INNODB_DATA_PENDING_READS', '0'),
('INNODB_DATA_PENDING_WRITES', '0'),
('INNODB_DATA_READ', '6156161024'),
('INNODB_DATA_READS', '303256'),
('INNODB_DATA_WRITES', '1303'),
('INNODB_DATA_WRITTEN', '25539584'),
('INNODB_DBLWR_PAGES_WRITTEN', '765'),
('INNODB_DBLWR_WRITES', '124'),
('INNODB_LOG_WAITS', '0'),
('INNODB_LOG_WRITE_REQUESTS', '701'),
('INNODB_LOG_WRITES', '347'),
('INNODB_OS_LOG_FSYNCS', '424'),
('INNODB_OS_LOG_PENDING_FSYNCS', '0'),
('INNODB_OS_LOG_PENDING_WRITES', '0'),
('INNODB_OS_LOG_WRITTEN', '432640'),
('INNODB_PAGE_SIZE', '16384'),
('INNODB_PAGES_CREATED', '5'),
('INNODB_PAGES_READ', '375481'),
('INNODB_PAGES_WRITTEN', '765'),
('INNODB_ROW_LOCK_CURRENT_WAITS', '0'),
('INNODB_ROW_LOCK_TIME', '0'),
('INNODB_ROW_LOCK_TIME_AVG', '0'),
('INNODB_ROW_LOCK_TIME_MAX', '0'),
('INNODB_ROW_LOCK_WAITS', '0'),
('INNODB_ROWS_DELETED', '78'),
('INNODB_ROWS_INSERTED', '80'),
('INNODB_ROWS_READ', '12254'),
('INNODB_ROWS_UPDATED', '182'),
('KEY_BLOCKS_NOT_FLUSHED', '0'),
('KEY_BLOCKS_UNUSED', '1712747'),
('KEY_BLOCKS_USED', '9011'),
('KEY_READ_REQUESTS', '105207742'),
('KEY_READS', '150251'),
('KEY_WRITE_REQUESTS', '143530'),
('KEY_WRITES', '70899'),
...
('OPEN_FILES', '2031'),
('OPEN_STREAMS', '0'),
('OPEN_TABLE_DEFINITIONS', '16384'),
('OPEN_TABLES', '1024'),
('OPENED_FILES', '1890171'),
('OPENED_TABLE_DEFINITIONS', '332942'),
('OPENED_TABLES', '857588'),
('PREPARED_STMT_COUNT', '0'),
('QCACHE_FREE_BLOCKS', '2605'),
('QCACHE_FREE_MEMORY', '90165560'),
('QCACHE_HITS', '290126'),
('QCACHE_INSERTS', '135362'),
('QCACHE_LOWMEM_PRUNES', '0'),
('QCACHE_NOT_CACHED', '39940'),
('QCACHE_QUERIES_IN_CACHE', '24897'),
('QCACHE_TOTAL_BLOCKS', '59761'),
('QUERIES', '648468'),
('QUESTIONS', '648468'),
('RPL_STATUS', 'NULL'),
('SELECT_FULL_JOIN', '1907'),
('SELECT_FULL_RANGE_JOIN', '1'),
('SELECT_RANGE', '57368'),
('SELECT_RANGE_CHECK', '249'),
('SELECT_SCAN', '38724'),
...
('SORT_ROWS', '1098077'),
('SORT_SCAN', '7058'),
('TABLE_LOCKS_IMMEDIATE', '296381'),
('TABLE_LOCKS_WAITED', '179'),
...
('THREADS_RUNNING', '3'),
('UPTIME', '29413'),
('UPTIME_SINCE_FLUSH_STATUS', '29413');
...
('BASEDIR', '/usr/local/'),
('PID_FILE', '/var/db/mysql/vh12.radiushost.ru.pid'),
...
('VERSION_COMMENT', 'FreeBSD port: mysql-server-5.1.61'),
('SYNC_FRM', 'ON'),
('PROFILING', 'OFF'),
...
('LOG_BIN', 'OFF'),
('GENERAL_LOG_FILE', '/var/db/mysql/vh12.log'),
...
('LOG_ERROR', '/var/db/mysql/vh12.radiushost.ru.err'),
('LOCAL_INFILE', 'ON'),
('REPORT_USER', ''),
('HAVE_RTREE_KEYS', 'YES'),
('LOG', 'OFF'),
...
(NULL, 'jerihon_rt_database', 'PRIMARY', NULL, 'jerihon_rt_database', 'activation', 'id', 1, NULL, NULL, NULL, NULL);
...
(NULL, 'information_schema', 'CHARACTER_SETS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 384, 0, 16434816, 0, 0, '2018-03-20 21:34:34', NULL, NULL, NULL, '', '', NULL),
(NULL, 'information_schema', 'COLLATIONS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 231, 0, 16704765, 0, 0, '2018-03-20 21:34:34', NULL, NULL, NULL, '', '', NULL),
(NULL, 'information_schema', 'COLLATION_CHARACTER_SET_APPLICABILITY', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 195, 0, 16357770, 0, 0, '2018-03-20 21:34:34', NULL, NULL, NULL, '', '', NULL),
(NULL, 'information_schema', 'COLUMNS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2018-03-20 21:34:34', '2018-03-20 21:34:34', NULL, NULL, '', '', NULL),
(NULL, 'information_schema', 'COLUMN_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2565, 0, 16757145, 0, 0, '2018-03-20 21:34:34', NULL, NULL, NULL, '', '', NULL),
(NULL, 'information_schema', 'ENGINES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 490, 0, 16574250, 0, 0, '2018-03-20 21:34:34', NULL, NULL, NULL, '', '', NULL),
(NULL, 'information_schema', 'EVENTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2018-03-20 21:34:34', '2018-03-20 21:34:34', NULL, NULL, '', '', NULL),
(NULL, 'information_schema', 'FILES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2677, 0, 16758020, 0, 0, '2018-03-20 21:34:34', NULL, NULL, NULL, '', '', NULL),
(NULL, 'information_schema', 'GLOBAL_STATUS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2018-03-20 21:34:34', NULL, NULL, NULL, '', '', NULL),
(NULL, 'information_schema', 'GLOBAL_VARIABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2018-03-20 21:34:34', NULL, NULL, NULL, '', '', NULL),
(NULL, 'information_schema', 'KEY_COLUMN_USAGE', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 4637, 0, 16762755, 0, 0, '2018-03-20 21:34:34', NULL, NULL, NULL, '', '', NULL),
(NULL, 'information_schema', 'PARTITIONS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2018-03-20 21:34:34', '2018-03-20 21:34:34', NULL, NULL, '', '', NULL),
(NULL, 'information_schema', 'PLUGINS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2018-03-20 21:34:34', '2018-03-20 21:34:34', NULL, NULL, '', '', NULL),
(NULL, 'information_schema', 'PROCESSLIST', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2018-03-20 21:34:34', '2018-03-20 21:34:34', NULL, NULL, '', '', NULL),
(NULL, 'information_schema', 'PROFILING', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 308, 0, 16562084, 0, 0, '2018-03-20 21:34:34', NULL, NULL, NULL, '', '', NULL),
(NULL, 'information_schema', 'REFERENTIAL_CONSTRAINTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 4814, 0, 16767162, 0, 0, '2018-03-20 21:34:34', NULL, NULL, NULL, '', '', NULL),
(NULL, 'information_schema', 'ROUTINES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2018-03-20 21:34:34', '2018-03-20 21:34:34', NULL, NULL, '', '', NULL),
(NULL, 'information_schema', 'SCHEMATA', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3464, 0, 16738048, 0, 0, '2018-03-20 21:34:34', NULL, NULL, NULL, '', '', NULL),
(NULL, 'information_schema', 'SCHEMA_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2179, 0, 16736899, 0, 0, '2018-03-20 21:34:34', NULL, NULL, NULL, '', '', NULL),
(NULL, 'information_schema', 'SESSION_STATUS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2018-03-20 21:34:34', NULL, NULL, NULL, '', '', NULL),
(NULL, 'information_schema', 'SESSION_VARIABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2018-03-20 21:34:34', NULL, NULL, NULL, '', '', NULL),
(NULL, 'information_schema', 'STATISTICS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2679, 0, 16770540, 0, 0, '2018-03-20 21:34:34', NULL, NULL, NULL, '', '', NULL),
(NULL, 'information_schema', 'TABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3545, 0, 16743035, 0, 0, '2018-03-20 21:34:34', NULL, NULL, NULL, '', '', NULL),
(NULL, 'information_schema', 'TABLE_CONSTRAINTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2504, 0, 16721712, 0, 0, '2018-03-20 21:34:34', NULL, NULL, NULL, '', '', NULL),
(NULL, 'information_schema', 'TABLE_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2372, 0, 16748692, 0, 0, '2018-03-20 21:34:34', NULL, NULL, NULL, '', '', NULL),
(NULL, 'information_schema', 'TRIGGERS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2018-03-20 21:34:34', '2018-03-20 21:34:34', NULL, NULL, '', '', NULL),
(NULL, 'information_schema', 'USER_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 1986, 0, 16726092, 0, 0, '2018-03-20 21:34:34', NULL, NULL, NULL, '', '', NULL),
(NULL, 'information_schema', 'VIEWS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2018-03-20 21:34:34', '2018-03-20 21:34:34', NULL, NULL, '', '', NULL),
(NULL, 'jerihon_rt_database', 'activation', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 8192, 16384, NULL, 0, 901775360, '2018-03-18 21:31:32', NULL, NULL, NULL, '', '', NULL);
...
(32565, 'jerihon_rt_user', 'localhost', NULL, 'Query', 0, 'executing', 'SELECT * FROM `information_schema`.`PROCESSLIST`');
...
(NULL, 'jerihon_rt_database', 'utf8', 'utf8_general_ci', NULL);
...
('''jerihon_rt_user''@''localhost''', NULL, 'jerihon\\_rt\\_database', 'SELECT', 'NO'),
('''jerihon_rt_user''@''localhost''', NULL, 'jerihon\\_rt\\_database', 'INSERT', 'NO'),
('''jerihon_rt_user''@''localhost''', NULL, 'jerihon\\_rt\\_database', 'UPDATE', 'NO'),
('''jerihon_rt_user''@''localhost''', NULL, 'jerihon\\_rt\\_database', 'DELETE', 'NO'),
('''jerihon_rt_user''@''localhost''', NULL, 'jerihon\\_rt\\_database', 'CREATE', 'NO'),
('''jerihon_rt_user''@''localhost''', NULL, 'jerihon\\_rt\\_database', 'DROP', 'NO'),
('''jerihon_rt_user''@''localhost''', NULL, 'jerihon\\_rt\\_database', 'REFERENCES', 'NO'),
('''jerihon_rt_user''@''localhost''', NULL, 'jerihon\\_rt\\_database', 'INDEX', 'NO'),
('''jerihon_rt_user''@''localhost''', NULL, 'jerihon\\_rt\\_database', 'ALTER', 'NO'),
('''jerihon_rt_user''@''localhost''', NULL, 'jerihon\\_rt\\_database', 'CREATE TEMPORARY TABLES', 'NO'),
('''jerihon_rt_user''@''localhost''', NULL, 'jerihon\\_rt\\_database', 'LOCK TABLES', 'NO'),
('''jerihon_rt_user''@''localhost''', NULL, 'jerihon\\_rt\\_database', 'EXECUTE', 'NO'),
('''jerihon_rt_user''@''localhost''', NULL, 'jerihon\\_rt\\_database', 'CREATE VIEW', 'NO'),
('''jerihon_rt_user''@''localhost''', NULL, 'jerihon\\_rt\\_database', 'SHOW VIEW', 'NO'),
('''jerihon_rt_user''@''localhost''', NULL, 'jerihon\\_rt\\_database', 'CREATE ROUTINE', 'NO'),
('''jerihon_rt_user''@''localhost''', NULL, 'jerihon\\_rt\\_database', 'ALTER ROUTINE', 'NO'),
('''jerihon_rt_user''@''localhost''', NULL, 'jerihon\\_rt\\_database', 'EVENT', 'NO'),
('''jerihon_rt_user''@''localhost''', NULL, 'jerihon\\_rt\\_database', 'TRIGGER', 'NO');
...
('INNODB_BUFFER_POOL_READ_AHEAD_RND', '11167'),
('INNODB_BUFFER_POOL_READ_AHEAD_SEQ', '124'),
('INNODB_BUFFER_POOL_READ_REQUESTS', '6301699'),
('INNODB_BUFFER_POOL_READS', '275299'),
('INNODB_BUFFER_POOL_WAIT_FREE', '0'),
('INNODB_BUFFER_POOL_WRITE_REQUESTS', '2528'),
('INNODB_DATA_FSYNCS', '672'),
...
(NULL, 'jerihon_rt_database', 'activation', 0, 'jerihon_rt_database', 'PRIMARY', 1, 'id', 'A', 2, NULL, NULL, '', 'BTREE', '');
...
(NULL, 'information_schema', 'CHARACTER_SETS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 384, 0, 16434816, 0, 0, NULL, '2018-03-20 21:34:34', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=43690', ''),
(NULL, 'information_schema', 'COLLATIONS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 231, 0, 16704765, 0, 0, NULL, '2018-03-20 21:34:34', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=72628', ''),
(NULL, 'information_schema', 'COLLATION_CHARACTER_SET_APPLICABILITY', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 195, 0, 16357770, 0, 0, NULL, '2018-03-20 21:34:34', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=86037', ''),
(NULL, 'information_schema', 'COLUMNS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2018-03-20 21:34:34', '2018-03-20 21:34:34', NULL, 'utf8_general_ci', NULL, 'max_rows=291856', ''),
(NULL, 'information_schema', 'COLUMN_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2565, 0, 16757145, 0, 0, NULL, '2018-03-20 21:34:34', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=6540', ''),
(NULL, 'information_schema', 'ENGINES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 490, 0, 16574250, 0, 0, NULL, '2018-03-20 21:34:34', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=34239', ''),
(NULL, 'information_schema', 'EVENTS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2018-03-20 21:34:34', '2018-03-20 21:34:34', NULL, 'utf8_general_ci', NULL, 'max_rows=39614', ''),
(NULL, 'information_schema', 'FILES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2677, 0, 16758020, 0, 0, NULL, '2018-03-20 21:34:34', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=6267', ''),
(NULL, 'information_schema', 'GLOBAL_STATUS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2018-03-20 21:34:34', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
(NULL, 'information_schema', 'GLOBAL_VARIABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2018-03-20 21:34:34', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
(NULL, 'information_schema', 'KEY_COLUMN_USAGE', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 4637, 0, 16762755, 0, 0, NULL, '2018-03-20 21:34:34', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=3618', ''),
(NULL, 'information_schema', 'PARTITIONS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2018-03-20 21:34:34', '2018-03-20 21:34:34', NULL, 'utf8_general_ci', NULL, 'max_rows=359231', ''),
(NULL, 'information_schema', 'PLUGINS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2018-03-20 21:34:34', '2018-03-20 21:34:34', NULL, 'utf8_general_ci', NULL, 'max_rows=833650', ''),
(NULL, 'information_schema', 'PROCESSLIST', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2018-03-20 21:34:34', '2018-03-20 21:34:34', NULL, 'utf8_general_ci', NULL, 'max_rows=1529546', ''),
(NULL, 'information_schema', 'PROFILING', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 308, 0, 16562084, 0, 0, NULL, '2018-03-20 21:34:34', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=54471', ''),
(NULL, 'information_schema', 'REFERENTIAL_CONSTRAINTS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 4814, 0, 16767162, 0, 0, NULL, '2018-03-20 21:34:34', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=3485', ''),
(NULL, 'information_schema', 'ROUTINES', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2018-03-20 21:34:34', '2018-03-20 21:34:34', NULL, 'utf8_general_ci', NULL, 'max_rows=37655', ''),
(NULL, 'information_schema', 'SCHEMATA', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3464, 0, 16738048, 0, 0, NULL, '2018-03-20 21:34:34', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=4843', ''),
(NULL, 'information_schema', 'SCHEMA_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2179, 0, 16736899, 0, 0, NULL, '2018-03-20 21:34:34', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=7699', ''),
(NULL, 'information_schema', 'SESSION_STATUS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2018-03-20 21:34:34', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
(NULL, 'information_schema', 'SESSION_VARIABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2018-03-20 21:34:34', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
(NULL, 'information_schema', 'STATISTICS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2679, 0, 16770540, 0, 0, NULL, '2018-03-20 21:34:34', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=6262', ''),
(NULL, 'information_schema', 'TABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3545, 0, 16743035, 0, 0, NULL, '2018-03-20 21:34:34', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=4732', ''),
(NULL, 'information_schema', 'TABLE_CONSTRAINTS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2504, 0, 16721712, 0, 0, NULL, '2018-03-20 21:34:34', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=6700', ''),
(NULL, 'information_schema', 'TABLE_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2372, 0, 16748692, 0, 0, NULL, '2018-03-20 21:34:34', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=7073', ''),
(NULL, 'information_schema', 'TRIGGERS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2018-03-20 21:34:34', '2018-03-20 21:34:34', NULL, 'utf8_general_ci', NULL, 'max_rows=36444', ''),
(NULL, 'information_schema', 'USER_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 1986, 0, 16726092, 0, 0, NULL, '2018-03-20 21:34:34', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=8447', ''),
(NULL, 'information_schema', 'VIEWS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2018-03-20 21:34:34', '2018-03-20 21:34:34', NULL, 'utf8_general_ci', NULL, 'max_rows=443694', ''),
(NULL, 'jerihon_rt_database', 'activation', 'BASE TABLE', 'InnoDB', 10, 'Compact', 2, 8192, 16384, 0, 0, 901775360, 11, '2018-03-18 21:31:32', NULL, NULL, 'utf8_general_ci', NULL, '', '');
...
(NULL, 'jerihon_rt_database', 'PRIMARY', 'jerihon_rt_database', 'activation', 'PRIMARY KEY');
...
('''jerihon_rt_user''@''localhost''', NULL, 'USAGE', 'NO');
...
--
-- База данных: `jerihon_rt_database`
--
CREATE DATABASE `jerihon_rt_database` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `jerihon_rt_database`;
...
INSERT INTO `activation` (`id`, `username`, `userkey`, `machineid`, `date`) VALUES
(5, 'kkulikova', '783EU-ZDHKK-9D96A-YZDTT', '3f74319b1bcf57bfdf30fde1a56a3812', 1521328803),
(6, 'ekulikov', 'B9FFU-ZD5S5-15A8B-YZZKD', '3f74319b1bcf57bfdf30fde1a56a3812', 1521494576);
